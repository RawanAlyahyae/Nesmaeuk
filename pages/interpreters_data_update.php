<html dir="rtl" lang="en">
  <head>
    <title>Interpreters Data Update</title>
    <meta charset="UTF-8" />
        ...
        <?php
          session_start();
            if(!empty($_SESSION['Usertype'])){
              ...
              $InterpreterEmail=$_GET['Email'];
              /*echo $InterpreterEmail;*/
              ?>
          ...
          <center>
            ...
            <?php
              ...
              {            
                  ...
                  $check_user=mysqli_query($DB_con,"select * from interpreters where ID = $InterpreterID") or die(mysqli_error($DB_con));
                  $result=mysqli_fetch_array($check_user);

                  $Name=$result['InterpreterName'];
                  $City=$result['City'];
                  $Email=$result['Email'];
                  $ID_No=$result['ID_No'];
                  $Path=$result['Imgpath'];
              ?>
                ...
                <center>
                <form class="Form" name="update" action="interpreters_data_update_code.php" method="post" enctype="multipart/form-data"><br>
                  <span class="label1">تعديل بيانات المترجم</span><br><br>
                  <table>
                    <tr><br><br>
                      <td><b style="color:black">اسم المترجم:</b></td>
                    ...
                    <tr>
                      <td><br><b style="color:black">رقم الرخصة:</b></td>
                      <td><br><input type="text" name="ID_No" value="<?php echo $ID_No ?>" maxlength="10"/></td>
                    </tr>
                  </table>
