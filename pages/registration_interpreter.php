<html dir="rtl" lang="en">
  <head>
    <meta charset="UTF-8"/>
    <title>Create Account (Interpreter)</title>
  ...
  <body>
    <div class="homePage">
      <div class="navigation">
        ...
        <div class="container_interpreter">
          <h1 class="form-title">حساب جديد (مترجم)</h1>
          <form action="registration_interpreter_code.php" method="post" enctype="multipart/form-data">
            ...
            <div class="main-user-info">
              ...
              <div class="user-input-box">
                <label for="ID_No"><span class="star">*</span>الهوية/ رخصة</label>
                <input type="text" id="ID_No" name="ID_No" placeholder="xxxxxxxx" maxlength="10" required/>
              </div>
              
              <div class="user-input-box">
                <label for="Language"><span class="star">*</span>اختر اللغة</label>
            ...
            <a href="terms&conditions.php" target="_blank"><b>الشروط والأحكام</b></a><br>

            <center>
              <div class="form-submit-btn1">
