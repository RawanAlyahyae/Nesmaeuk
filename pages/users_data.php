    ...
    <div class="homePage">
      ...
      <div class="rectangle17">
        ...
        <?php 
		      ...
		      $check_users=mysqli_query($db_conn,"select * from users where Usertype='user'") or die(mysqli_error($db_conn));
          ...
          <center>
            <table class="Users_Table" border="5" cellspacing="5" cellpadding="5">
              ...
              <th>التحكم في بيانات المستخدم</th>
              </tr>
        ...
        <?php
              while($result=mysqli_fetch_array($check_users)){
                ...
                echo"<td><a href='users_data_update.php?ID=$UserID'><button class='Update_Button'>تعديل</button></a>";
                echo"<a href='users_data_delete.php?ID=$UserID'><button class='Delete_Button'>حذف</button></a></td></tr>";
              }
        ?>	
